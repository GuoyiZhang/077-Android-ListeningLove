...
import com.guoyi.musicapi.netease.CatListBean
import com.guoyi.musicapi.netease.SubItem
...
import com.guoyi.listeninglove.ui.music.playlist.PlaylistActivity
import com.guoyi.listeninglove.ui.widget.channel.Channel
import com.guoyi.listeninglove.ui.widget.channel.ChannelView
...
class AllPlaylistCatFragment : androidx.fragment.app.DialogFragment(), ChannelView.OnChannelListener {
    ...
    private val backIv by lazy { rootView?.findViewById<ImageView>(com.guoyi.listeninglove.R.id.backIv) }
    ...
    override fun onStart() {
        dialog?.let {
            ...
            lp?.windowAnimations = com.guoyi.listeninglove.R.style.dialogAnim
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        if (rootView == null) {
            rootView = inflater.inflate(com.guoyi.listeninglove.R.layout.frag_playlist_category, container, false)
        }
