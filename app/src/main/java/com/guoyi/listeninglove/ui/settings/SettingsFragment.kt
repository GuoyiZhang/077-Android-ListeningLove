...
class SettingsFragment : PreferenceFragment(), Preference.OnPreferenceClickListener {
    ...
    private var mPreferenceAbout: PreferenceScreen? = null
    private var mPreferenceEqualizer: PreferenceScreen? = null
    private var mPreferenceAboutFeedback: PreferenceScreen? = null
    ...
    private fun initView() {
        mPreferenceAbout = findPreference("key_about") as PreferenceScreen
        mPreferenceEqualizer = findPreference("key_equalizer") as PreferenceScreen
        mPreferenceAboutFeedback = findPreference("key_about_feedback") as PreferenceScreen
        ...
        mPreferenceAbout!!.onPreferenceClickListener = this
        mPreferenceEqualizer!!.onPreferenceClickListener = this
        mPreferenceAboutFeedback!!.onPreferenceClickListener = this
    ...
    override fun onPreferenceClick(preference: Preference): Boolean {
        when (preference.key) {
            ...
            "key_equalizer" -> {
                navigateToSoundEffect(activity)
            }
            "key_about_feedback" -> {
                feeback(context)
            }
